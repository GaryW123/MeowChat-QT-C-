...
QT_MOC_LITERAL(5, 53, 12), // "bytesArrived"
QT_MOC_LITERAL(6, 66, 11) // "receiveFile"

    },
    "TcpThread\0error\0\0QTcpSocket::SocketError\0"
    "socketError\0bytesArrived\0receiveFile"
};
...
void TcpThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TcpThread::*)(qint64 , qint32 , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpThread::bytesArrived)) {
                *result = 1;
                return;
            }
        }
