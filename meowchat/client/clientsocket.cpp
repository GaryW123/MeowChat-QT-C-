    ...
    if (!doucment.isNull() && (jsonError.error == QJsonParseError::NoError)) {
        ...
        if (doucment.isObject()) {
            ...
            case AddGroup://创建群聊
            {
                ...
                break;
            case AddFriendRequist://添加好友请求
            {
                Q_EMIT signalMessage(AddFriendRequist, dataVal);
            }
                break;
            case AddGroupRequist://添加群组请求
            {
